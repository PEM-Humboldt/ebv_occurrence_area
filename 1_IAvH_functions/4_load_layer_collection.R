...
aa<- saveRDS(stac_colections_layers$`chelsa-clim`, "aa.rds")
readRDS("aa.rds")
...
save(repository_stac, repository_collections, colections_stac, stac_colections_layers, file= output_RData )
